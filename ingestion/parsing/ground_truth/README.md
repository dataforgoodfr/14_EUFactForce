...
- **Order policy:** text is organized to reflect logical reading order of the article/report content. If a figure cuts a paragraph in half, the ground truth will instead choose to finish the paragraph before mentioning the figure.
- **Heading consistency:** headings are kept readable and stable, without arbitrary relabeling. Heading hierarchy is not conserved at this moment, all titles are considered level 1 titles.
