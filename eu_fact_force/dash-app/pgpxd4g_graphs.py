# -*- coding: utf-8 -*-
"""PGPxD4G_graphs.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1A3xnBoI-FUp62eFTT0RQPpYPU-TrubZ0
"""
...
DATA_PATH = "/content/PGP x D4G- Exported Vaccine Data.xlsx" # Correct to the actual Excel file
...
fig_source = go.Figure(go.Pie(
    ...
    textinfo="label", # Simplified from "label+percent"
    hovertemplate="<b>%{label}</b><br>%{value:,} mentions<extra></extra>", # Simplified
))
